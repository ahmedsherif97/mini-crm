...
<head>
    ...
    <title>Dashboard - Analytics | {{ app('settings')->find('name') }}</title>
...
{{--                        </div>--}}
    ...
    <script type="text/javascript">
        ...
        toggleButtons.forEach(toggleButton => {
            const passwordField = toggleButton.parentElement.previousElementSibling.querySelector('.form-control');
