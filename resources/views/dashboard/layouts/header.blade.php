         ...
         <div class="navbar-nav align-items-center">
             <div class="nav-item navbar-search-wrapper mb-0">
                 <a class="nav-item nav-link search-toggler px-0" href="javascript:void(0);">
                     ...
                     <span class="d-none d-md-inline-block text-muted">{{ __('dashboard.search') }} (Ctrl+/)</span>
                 </a>
             </div>
         </div>
         <!-- /Search -->
                     ...
                     @can('list setting')
                         <li>
                             <a class="dropdown-item" href="{{ route('dashboard.setting.index') }}">
                                 ...
                                 <span class="align-middle">{{ __('dashboard.settings') }}</span>
                             </a>
                         </li>
                     @endcan
                     @can('update auth')
                         <li>
                             <a class="dropdown-item" href="{{ route('auth.password.change') }}">
                                 <i class="bx bx-cog me-2"></i>
                                 <span class="align-middle">{{ __('dashboard.update.password') }}</span>
                             </a>
                         </li>
                     @endcan
                     <li>
